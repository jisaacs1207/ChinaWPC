...
namespace ChinaWPC
{
    public partial class MainPage
    {
        ...
        public static int UniversityPoints;
        public static int IpOwnerPoints;

        public static int SalaryPoints;
        public static int WorkMonthsPoints;
        public static int ExperiencePoints;
        public static int F500Points;

        public static int ChinesePoints;
        public static int FiveYearsPoints;
        public static int HighNeedPoints;
        public static int ProvincialPoints;
        ...
        private void Handle_Tapped_2(object sender, EventArgs e)
        {
        ...
        private void Handle_Tapped_3(object sender, EventArgs e)
        {
        ...
        private void Handle_Tapped_4(object sender, EventArgs e)
        {
        ...
        private void Handle_Tapped_5(object sender, EventArgs e)
        {
        ...
        private void Button_OnClicked6(object sender, EventArgs e)
        {
            ...
            {
                Text = "My Visa Score Is " + Utility.CallTotalPoints().ToString() + "\nWhat's Yours?" ,
                Title = "Find out now!",
                Url = "https://chinawpc.jakdev.io"
            });
        }
    }
}